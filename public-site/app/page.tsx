...
export default function Home() {
  ...
  return <><main>
    <nav><a className="mark omega-mark" href="#top" aria-label="LEIS home"><span aria-hidden="true">Ω</span><b>LEIS</b></a><div><a href="#orientation">Start here</a><a href="#timeline">Our story</a><a href="#earth">Earth Pulse</a><a href="#grants">Support LEIS</a><a href="#media">Media</a></div></nav>
