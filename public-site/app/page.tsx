...
const translationTables: Array<[string, Partial<Record<Language, unknown>>]> = [
  ...
  ["Prague context", pragueCopy], ["contact", contactCopy], ["orientation guide", guideCopy], ["Ask LEIS", askLeisCopy], ["Ask LEIS send", askSendCopy], ["AI handoff", aiHandoffCopy], ["public Ask LEIS routing", publicRouteCopy], ["timeline", localizedMilestones],
