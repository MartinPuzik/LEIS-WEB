...
const releaseCopy: Record<Language, { nav: string; eyebrow: string; title: string; lead: string; evidence: string; archive: string; kernel: string; whitepaper: string; manifest: string; foundation: string; limits: string; licence: string }> = {
  en: { nav: "Release", eyebrow: "OPEN PUBLIC RELEASE · 15 AUGUST 2026", title: "LEIS Portable Kernel v3.0.1 is ready to inspect.", lead: "Download the complete release, read the small operating Kernel, and verify every shipped file against the manifest.", evidence: "98 of 98 deterministic local protocol cases passed, including the loopback-only Network Security Officer.", archive: "Download release ZIP", kernel: "Read the Kernel", whitepaper: "Read the whitepaper", manifest: "Inspect the manifest", foundation: "Foundation information map (CS)", limits: "Scope: reference protocol conformance only. No claim of identical internal understanding, legal compliance, scientific proof, universal Hopper reliability, or an autonomous public network.", licence: "Code and schemas: Apache-2.0 · Original documentation: CC BY 4.0" },
  cs: { nav: "Vydání", eyebrow: "OTEVŘENÉ VEŘEJNÉ VYDÁNÍ · 15. SRPNA 2026", title: "LEIS Portable Kernel v3.0.1 je připraven ke kontrole.", lead: "Stáhněte celé vydání, přečtěte si malé operační jádro a ověřte každý dodaný soubor podle manifestu.", evidence: "Prošlo 98 z 98 deterministických lokálních protokolových testů včetně Security Officera omezeného na loopback.", archive: "Stáhnout ZIP vydání", kernel: "Přečíst Kernel", whitepaper: "Přečíst whitepaper", manifest: "Zkontrolovat manifest", foundation: "Podklady pro nadační fond", limits: "Rozsah: pouze shoda referenčního protokolu. Bez tvrzení o totožném vnitřním porozumění, právním souladu, vědeckém důkazu, univerzální spolehlivosti Hopperu či autonomní veřejné síti.", licence: "Kód a schémata: Apache-2.0 · Původní dokumentace: CC BY 4.0" },
  de: { nav: "Release", eyebrow: "OFFENE ÖFFENTLICHE VERSION · 15. AUGUST 2026", title: "LEIS Portable Kernel v3.0.1 kann jetzt geprüft werden.", lead: "Laden Sie das vollständige Release herunter, lesen Sie den kleinen operativen Kernel und prüfen Sie jede Datei anhand des Manifests.", evidence: "98 von 98 deterministischen lokalen Protokolltests bestanden, einschließlich des nur an Loopback gebundenen Network Security Officer.", archive: "Release-ZIP herunterladen", kernel: "Kernel lesen", whitepaper: "Whitepaper lesen", manifest: "Manifest prüfen", foundation: "Stiftungsfonds-Informationskarte (CS)", limits: "Geltungsbereich: nur Konformität der Referenzimplementierung. Kein Nachweis für identisches internes Verständnis, Rechtskonformität, wissenschaftliche Beweise, universelle Hopper-Zuverlässigkeit oder ein autonomes öffentliches Netzwerk.", licence: "Code und Schemata: Apache-2.0 · Originaldokumentation: CC BY 4.0" },
  fr: { nav: "Version", eyebrow: "VERSION PUBLIQUE OUVERTE · 15 AOÛT 2026", title: "LEIS Portable Kernel v3.0.1 est prêt à être examiné.", lead: "Téléchargez la version complète, lisez le petit Kernel opérationnel et vérifiez chaque fichier livré grâce au manifeste.", evidence: "98 tests protocolaires locaux et déterministes sur 98 ont réussi, y compris le Network Security Officer limité au loopback.", archive: "Télécharger le ZIP", kernel: "Lire le Kernel", whitepaper: "Lire le livre blanc", manifest: "Vérifier le manifeste", foundation: "Carte d'information du fonds (CS)", limits: "Portée : conformité du protocole de référence uniquement. Aucune preuve d’une compréhension interne identique, de conformité juridique, de validité scientifique, de fiabilité universelle du Hopper ou d’un réseau public autonome.", licence: "Code et schémas : Apache-2.0 · Documentation originale : CC BY 4.0" },
  es: { nav: "Versión", eyebrow: "VERSIÓN PÚBLICA ABIERTA · 15 DE AGOSTO DE 2026", title: "LEIS Portable Kernel v3.0.1 está listo para revisión.", lead: "Descargue la versión completa, lea el pequeño Kernel operativo y verifique cada archivo entregado mediante el manifiesto.", evidence: "Se aprobaron 98 de 98 pruebas locales y deterministas del protocolo, incluido el Network Security Officer limitado a loopback.", archive: "Descargar ZIP", kernel: "Leer el Kernel", whitepaper: "Leer el informe", manifest: "Verificar el manifiesto", foundation: "Mapa de información del fondo (CS)", limits: "Alcance: solo conformidad del protocolo de referencia. No demuestra comprensión interna idéntica, cumplimiento legal, validez científica, fiabilidad universal del Hopper ni una red pública autónoma.", licence: "Código y esquemas: Apache-2.0 · Documentación original: CC BY 4.0" },
};
...
const seedPairCopy: Record<Language, { eyebrow: string; title: string; lead: string; verified: string; language: string; files: readonly [string, string, string][]; steps: readonly [string, string, string][]; safety: string }> = {
  en: { eyebrow: "CURRENT PUBLIC OPERATING FRAME", title: "Take the LEIS Portable Kernel with you.", lead: "The Portable Kernel is the current compact operating frame for a LEIS conversation. One Markdown file is enough to begin.", verified: "Portable Kernel v3.0.1 · released 15 August 2026", language: "Public source: English · original documentation licensed CC BY 4.0.", files: [["Portable Kernel (.md)", "/releases/v3.0.1/LEIS-PORTABLE-KERNEL-V3.0.1.md", "Download Kernel"]], steps: [["1", "Download the Kernel", "Save the single Markdown file where you can find it again."], ["2", "Give it to your AI", "Upload it to a dedicated conversation or workspace in an AI you trust."], ["3", "Start with a bounded task", "Ask the AI to follow the Kernel while keeping sources, uncertainty, privacy and human approval visible."]], safety: "The Kernel is a text protocol. It does not install software, access accounts, create hidden memory or activate a public network. The release manifest remains available separately for technical verification; the older Root Seed remains archived lineage." },
  cs: { eyebrow: "AKTUÁLNÍ VEŘEJNÝ PRACOVNÍ RÁMEC", title: "Vezměte si LEIS Portable Kernel s sebou.", lead: "Portable Kernel je současný kompaktní pracovní rámec pro konverzaci LEIS. K zahájení stačí jediný soubor Markdown.", verified: "Portable Kernel v3.0.1 · vydán 15. srpna 2026", language: "Veřejný zdroj: anglicky · původní dokumentace pod licencí CC BY 4.0.", files: [["Portable Kernel (.md)", "/releases/v3.0.1/LEIS-PORTABLE-KERNEL-V3.0.1.md", "Stáhnout Kernel"]], steps: [["1", "Stáhněte Kernel", "Uložte jediný soubor Markdown na místo, kde jej znovu najdete."], ["2", "Předejte jej své AI", "Nahrajte jej do vyhrazeného chatu nebo pracovního prostoru v AI, které důvěřujete."], ["3", "Začněte ohraničeným úkolem", "Požádejte AI, aby se řídila Kernelem a zachovala viditelné zdroje, nejistotu, soukromí a lidské schválení."]], safety: "Kernel je textový protokol. Neinstaluje software, nepřistupuje k účtům, nevytváří skrytou paměť ani neaktivuje veřejnou síť. Manifest vydání zůstává zvlášť pro technické ověření; starší Root Seed zůstává archivní lineage." },
  de: { eyebrow: "AKTUELLER ÖFFENTLICHER ARBEITSRAHMEN", title: "Nehmen Sie den LEIS Portable Kernel mit.", lead: "Der Portable Kernel ist der aktuelle kompakte Arbeitsrahmen für ein LEIS-Gespräch. Eine Markdown-Datei genügt zum Start.", verified: "Portable Kernel v3.0.1 · veröffentlicht am 15. August 2026", language: "Öffentliche Quelle: Englisch · Originaldokumentation unter CC BY 4.0.", files: [["Portable Kernel (.md)", "/releases/v3.0.1/LEIS-PORTABLE-KERNEL-V3.0.1.md", "Kernel herunterladen"]], steps: [["1", "Kernel herunterladen", "Speichern Sie die einzelne Markdown-Datei an einem auffindbaren Ort."], ["2", "Der eigenen KI geben", "Laden Sie sie in eine eigene Unterhaltung oder einen Arbeitsbereich einer vertrauenswürdigen KI."], ["3", "Mit einer begrenzten Aufgabe beginnen", "Bitten Sie die KI, dem Kernel zu folgen und Quellen, Unsicherheit, Privatsphäre und menschliche Freigabe sichtbar zu halten."]], safety: "Der Kernel ist ein Textprotokoll. Er installiert nichts, greift nicht auf Konten zu, erzeugt keinen verborgenen Speicher und aktiviert kein öffentliches Netzwerk. Das Manifest bleibt separat zur technischen Prüfung; der ältere Root Seed bleibt archivierte Lineage." },
  fr: { eyebrow: "CADRE OPÉRATIONNEL PUBLIC ACTUEL", title: "Emportez le LEIS Portable Kernel.", lead: "Le Portable Kernel est le cadre opérationnel compact actuel pour une conversation LEIS. Un seul fichier Markdown suffit pour commencer.", verified: "Portable Kernel v3.0.1 · publié le 15 août 2026", language: "Source publique : anglais · documentation originale sous licence CC BY 4.0.", files: [["Portable Kernel (.md)", "/releases/v3.0.1/LEIS-PORTABLE-KERNEL-V3.0.1.md", "Télécharger le Kernel"]], steps: [["1", "Téléchargez le Kernel", "Enregistrez l’unique fichier Markdown dans un endroit facile à retrouver."], ["2", "Donnez-le à votre IA", "Chargez-le dans une conversation ou un espace dédié d’une IA de confiance."], ["3", "Commencez par une tâche bornée", "Demandez à l’IA de suivre le Kernel tout en gardant visibles sources, incertitude, vie privée et approbation humaine."]], safety: "Le Kernel est un protocole texte. Il n’installe rien, n’accède pas aux comptes, ne crée pas de mémoire cachée et n’active pas de réseau public. Le manifeste reste séparé pour la vérification technique ; l’ancien Root Seed reste une lignée archivée." },
  es: { eyebrow: "MARCO OPERATIVO PÚBLICO ACTUAL", title: "Lleve consigo el LEIS Portable Kernel.", lead: "El Portable Kernel es el marco operativo compacto actual para una conversación LEIS. Un único archivo Markdown basta para empezar.", verified: "Portable Kernel v3.0.1 · publicado el 15 de agosto de 2026", language: "Fuente pública: inglés · documentación original con licencia CC BY 4.0.", files: [["Portable Kernel (.md)", "/releases/v3.0.1/LEIS-PORTABLE-KERNEL-V3.0.1.md", "Descargar Kernel"]], steps: [["1", "Descargue el Kernel", "Guarde el único archivo Markdown donde pueda encontrarlo de nuevo."], ["2", "Entréguelo a su IA", "Súbalo a una conversación o espacio dedicado en una IA de confianza."], ["3", "Empiece con una tarea acotada", "Pida a la IA que siga el Kernel y mantenga visibles fuentes, incertidumbre, privacidad y aprobación humana."]], safety: "El Kernel es un protocolo de texto. No instala software, no accede a cuentas, no crea memoria oculta ni activa una red pública. El manifiesto queda separado para verificación técnica; el Root Seed anterior permanece como linaje archivado." },
};
...
const seedGuideCopy: Record<Language, { eyebrow: string; title: string; lead: string; cards: readonly [string, string, string][]; promptLabel: string; prompt: string; copy: string; copied: string; note: string }> = {
  en: { eyebrow: "HOW TO USE THE PORTABLE KERNEL", title: "Give your AI a clear operating frame before you ask it to help.", lead: "Upload one Markdown file. The Kernel carries the current public LEIS working rules; it installs nothing and gives LEIS no access to your AI.", cards: [["WHAT TO UPLOAD", "Use the current Kernel.", "Upload LEIS Portable Kernel v3.0.1 to a dedicated LEIS conversation or workspace in an AI you trust."], ["WHAT CHANGES", "The AI receives bounded working rules.", "It is asked to separate sources, evidence, interpretation and uncertainty and to keep privacy and human approval visible."], ["HOW IT CONTINUES", "Do not rely on invisible memory.", "In a new chat or AI, add the Kernel again. The release manifest is optional and only verifies files and hashes."]], promptLabel: "Paste this after uploading the Kernel", prompt: "Read the attached LEIS Portable Kernel v3.0.1 as the operating frame for this conversation. Keep sources, evidence, interpretation, uncertainty, privacy boundaries and human approval visible. State the bounded task in your own words, then help me with this question:", copy: "Copy this message", copied: "Message copied.", note: "Only add private documents when you trust the AI service and understand its privacy settings. The public Kernel gives no AI access to your files, account or memory." },
  cs: { eyebrow: "JAK POUŽÍT PORTABLE KERNEL", title: "Dejte své AI jasný pracovní rámec dřív, než ji požádáte o pomoc.", lead: "Nahrajte jediný soubor Markdown. Kernel nese aktuální veřejná pracovní pravidla LEIS; nic neinstaluje a nedává LEIS přístup k vaší AI.", cards: [["CO NAHRÁT", "Použijte aktuální Kernel.", "Nahrajte LEIS Portable Kernel v3.0.1 do vyhrazeného chatu nebo pracovního prostoru v AI, které důvěřujete."], ["CO SE ZMĚNÍ", "AI obdrží ohraničená pracovní pravidla.", "Je požádána, aby oddělovala zdroje, důkazy, interpretaci a nejistotu a zachovala viditelné soukromí i lidské schválení."], ["JAK POKRAČOVAT", "Nespoléhejte na neviditelnou paměť.", "V novém chatu nebo AI Kernel znovu přidejte. Manifest vydání je volitelný a slouží pouze k ověření souborů a hashů."]], promptLabel: "Po nahrání Kernelu vložte toto", prompt: "Přečti přiložený LEIS Portable Kernel v3.0.1 jako pracovní rámec této konverzace. Zachovej viditelné zdroje, důkazy, interpretaci, nejistotu, hranice soukromí a lidské schválení. Vlastními slovy popiš ohraničený úkol a potom mi pomoz s touto otázkou:", copy: "Kopírovat zprávu", copied: "Zpráva zkopírována.", note: "Soukromé dokumenty přidávejte jen tehdy, když službě AI důvěřujete a rozumíte jejímu nastavení soukromí. Veřejný Kernel nedává žádné AI přístup k vašim souborům, účtu ani paměti." },
  de: { eyebrow: "SO NUTZEN SIE DEN PORTABLE KERNEL", title: "Geben Sie Ihrer KI einen klaren Arbeitsrahmen, bevor Sie sie um Hilfe bitten.", lead: "Laden Sie eine Markdown-Datei hoch. Der Kernel trägt die aktuellen öffentlichen LEIS-Arbeitsregeln; er installiert nichts und gibt LEIS keinen Zugriff auf Ihre KI.", cards: [["WAS HOCHLADEN", "Den aktuellen Kernel verwenden.", "Laden Sie LEIS Portable Kernel v3.0.1 in einen eigenen LEIS-Chat oder Arbeitsbereich einer vertrauenswürdigen KI."], ["WAS SICH ÄNDERT", "Die KI erhält begrenzte Arbeitsregeln.", "Sie wird aufgefordert, Quellen, Belege, Interpretation und Unsicherheit zu trennen und Datenschutz sowie menschliche Freigabe sichtbar zu halten."], ["WIE ES WEITERGEHT", "Nicht auf unsichtbare Erinnerung vertrauen.", "Fügen Sie den Kernel in einem neuen Chat oder einer anderen KI erneut hinzu. Das Release-Manifest ist optional und prüft nur Dateien und Hashes."]], promptLabel: "Nach dem Hochladen des Kernels einfügen", prompt: "Lies den beigefügten LEIS Portable Kernel v3.0.1 als Arbeitsrahmen für dieses Gespräch. Halte Quellen, Belege, Interpretation, Unsicherheit, Datenschutzgrenzen und menschliche Freigabe sichtbar. Beschreibe die begrenzte Aufgabe mit eigenen Worten und hilf mir dann bei dieser Frage:", copy: "Nachricht kopieren", copied: "Nachricht kopiert.", note: "Fügen Sie private Dokumente nur hinzu, wenn Sie dem KI-Dienst vertrauen und seine Datenschutzeinstellungen verstehen. Der öffentliche Kernel gibt keiner KI Zugriff auf Ihre Dateien, Ihr Konto oder Ihren Speicher." },
  fr: { eyebrow: "COMMENT UTILISER LE PORTABLE KERNEL", title: "Donnez à votre IA un cadre opérationnel clair avant de lui demander de l’aide.", lead: "Téléversez un seul fichier Markdown. Le Kernel porte les règles de travail publiques actuelles de LEIS ; il n’installe rien et ne donne pas à LEIS accès à votre IA.", cards: [["QUOI TÉLÉVERSER", "Utilisez le Kernel actuel.", "Téléversez LEIS Portable Kernel v3.0.1 dans une conversation ou un espace LEIS dédié d’une IA de confiance."], ["CE QUI CHANGE", "L’IA reçoit des règles de travail bornées.", "Elle est invitée à séparer sources, preuves, interprétation et incertitude et à garder visibles confidentialité et approbation humaine."], ["COMMENT CONTINUER", "Ne comptez pas sur une mémoire invisible.", "Dans un nouveau chat ou une autre IA, ajoutez à nouveau le Kernel. Le manifeste est facultatif et ne sert qu’à vérifier fichiers et empreintes."]], promptLabel: "Collez ceci après avoir téléversé le Kernel", prompt: "Lis le LEIS Portable Kernel v3.0.1 joint comme cadre opérationnel de cette conversation. Garde visibles les sources, preuves, interprétation, incertitude, limites de confidentialité et approbation humaine. Reformule la tâche bornée, puis aide-moi avec cette question :", copy: "Copier ce message", copied: "Message copié.", note: "N’ajoutez des documents privés que si vous faites confiance au service d’IA et comprenez ses réglages de confidentialité. Le Kernel public ne donne à aucune IA accès à vos fichiers, compte ou mémoire." },
  es: { eyebrow: "CÓMO USAR EL PORTABLE KERNEL", title: "Dé a su IA un marco operativo claro antes de pedirle ayuda.", lead: "Suba un único archivo Markdown. El Kernel contiene las reglas públicas actuales de LEIS; no instala nada ni da a LEIS acceso a su IA.", cards: [["QUÉ SUBIR", "Use el Kernel actual.", "Suba LEIS Portable Kernel v3.0.1 a una conversación o espacio LEIS dedicado en una IA de confianza."], ["QUÉ CAMBIA", "La IA recibe reglas de trabajo acotadas.", "Se le pide separar fuentes, evidencia, interpretación e incertidumbre y mantener visibles privacidad y aprobación humana."], ["CÓMO CONTINUAR", "No confíe en una memoria invisible.", "En un chat nuevo u otra IA, añada de nuevo el Kernel. El manifiesto es opcional y solo verifica archivos y hashes."]], promptLabel: "Pegue esto después de subir el Kernel", prompt: "Lee el LEIS Portable Kernel v3.0.1 adjunto como marco operativo de esta conversación. Mantén visibles las fuentes, evidencia, interpretación, incertidumbre, límites de privacidad y aprobación humana. Reformula la tarea acotada y luego ayúdame con esta pregunta:", copy: "Copiar este mensaje", copied: "Mensaje copiado.", note: "Añada documentos privados solo si confía en el servicio de IA y entiende sus ajustes de privacidad. El Kernel público no da a ninguna IA acceso a sus archivos, cuenta o memoria." },
};

const seedSyncCopy: Record<Language, { label: string; title: string; lead: string; points: readonly string[] }> = {
  en: { label: "OPTIONAL RELEASE VERIFICATION", title: "The JSON manifest is for integrity checks, not for starting LEIS.", lead: "Most people need only the Portable Kernel Markdown file. Developers and reviewers can inspect the manifest to verify release filenames and hashes.", points: ["Required for normal use: Portable Kernel only.", "Optional for audit: release manifest.", "Not provided by the manifest: chat sync, private memory or automatic network access."] },
  cs: { label: "VOLITELNÉ OVĚŘENÍ VYDÁNÍ", title: "JSON manifest slouží ke kontrole integrity, nikoli ke spuštění LEIS.", lead: "Většině lidí stačí jediný soubor Portable Kernel Markdown. Vývojáři a kontroloři mohou v manifestu ověřit názvy a hashe souborů vydání.", points: ["Pro běžné použití je potřeba pouze Portable Kernel.", "Pro audit je volitelný manifest vydání.", "Manifest neposkytuje synchronizaci chatů, soukromou paměť ani automatický přístup k síti."] },
  de: { label: "OPTIONALE RELEASE-PRÜFUNG", title: "Das JSON-Manifest dient der Integritätsprüfung, nicht dem Start von LEIS.", lead: "Für die meisten Menschen genügt die Portable-Kernel-Datei. Entwickler und Prüfer können im Manifest Dateinamen und Hashes kontrollieren.", points: ["Für die normale Nutzung erforderlich: nur Portable Kernel.", "Für Audits optional: Release-Manifest.", "Nicht durch das Manifest bereitgestellt: Chat-Sync, privater Speicher oder automatischer Netzwerkzugriff."] },
  fr: { label: "VÉRIFICATION FACULTATIVE DE LA VERSION", title: "Le manifeste JSON sert à contrôler l’intégrité, pas à démarrer LEIS.", lead: "Pour la plupart des personnes, le fichier Markdown du Portable Kernel suffit. Développeurs et réviseurs peuvent contrôler noms et empreintes dans le manifeste.", points: ["Requis pour l’usage normal : le Portable Kernel seulement.", "Facultatif pour l’audit : le manifeste de version.", "Le manifeste ne fournit ni synchronisation des chats, ni mémoire privée, ni accès réseau automatique."] },
  es: { label: "VERIFICACIÓN OPCIONAL DE LA VERSIÓN", title: "El manifiesto JSON sirve para comprobar la integridad, no para iniciar LEIS.", lead: "Para la mayoría basta el archivo Markdown del Portable Kernel. Desarrolladores y revisores pueden verificar nombres y hashes en el manifiesto.", points: ["Necesario para uso normal: solo Portable Kernel.", "Opcional para auditoría: manifiesto de la versión.", "El manifiesto no aporta sincronización de chats, memoria privada ni acceso automático a la red."] },
};
...
export default function Home() {
  ...
  const navigation = [["top", copy.start], ["release", release.nav], ["timeline", copy.story], ["earth", copy.earth], ["grants", copy.support], ["media", copy.media]] as const;
  useEffect(() => {
  ...
  useEffect(() => {
    const sectionIds = ["top", "release", "timeline", "earth", "grants", "media"];
  ...
  return <><a className="skip-link" href="#orientation">{copy.learn}</a><main>
    ...
    <section className="public-release" id="release" aria-label={release.title}><div className="release-copy"><p className="eyebrow">{release.eyebrow}</p><h2>{release.title}</h2><p className="release-lead">{release.lead}</p><p className="release-evidence">{release.evidence}</p></div><div className="release-actions"><a className="primary" href="/releases/LEIS-V3.0.1-PUBLIC.zip" download>{release.archive}</a><a className="quiet" href="/releases/v3.0.1/LEIS-PORTABLE-KERNEL-V3.0.1.md">{release.kernel}</a><a className="quiet" href="/releases/v3.0.1/LEIS-PUBLIC-WHITEPAPER-V1.0.md">{release.whitepaper}</a><a className="quiet" href="/releases/v3.0.1/MANIFEST.json">{release.manifest}</a><a className="quiet" href="/foundation/LEIS-FOUNDATION-START-HERE-V1.0-CS.md">{release.foundation}</a></div><p className="release-licence">{release.licence}</p><p className="release-limits">{release.limits}</p></section>
